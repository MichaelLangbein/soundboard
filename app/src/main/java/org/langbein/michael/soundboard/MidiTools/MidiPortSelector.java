...
package org.langbein.michael.soundboard.MidiTools;
...
public abstract class MidiPortSelector extends DeviceCallback {
     ...
     */
    public MidiPortSelector(MidiManager midiManager, Activity activity, int spinnerId, int type) {
    ...
    private int getInfoPortCount(final MidiDeviceInfo info) {
        int portCount = (mType == MidiDeviceInfo.PortInfo.TYPE_INPUT) ? info.getInputPortCount() : info.getOutputPortCount();
        return portCount;
    }
